...
export function SiteFooter() {
  ...
  return (
    <footer className="bg-brand text-background/90 mt-24">
      ...
      <div className="container mx-auto px-4 max-w-[1200px] py-12 grid gap-8 md:grid-cols-3 text-sm">
        <div>
          <p className="text-[0.625rem] uppercase tracking-kicker text-accent-subtle mb-2">Taean Insight</p>
          <p className="font-bold text-base mb-2">태안 인사이트</p>
      ...
      <div className="border-t border-background/10 py-3 text-center text-xs text-background/60">
        ...
        <a href="/admin" className="inline-flex items-center gap-1 rounded-full border border-background/40 px-3 py-1 font-semibold text-background/90 hover:bg-background/10">
          🔧 관리자
        </a>
      </div>
    </footer>
