...
// 지역 데이터(추세·다운로드) — 주간 리포트의 "데이터 부록"으로 흡수.
//  기관·업체용 시계열·CSV. (구 B2B 대시보드 본문을 재사용 컴포넌트로 추출)
...
export function RegionDataPanel() {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-xs text-foreground-muted">출처 기상청·에어코리아·국토교통부·오피넷 · 무료 공공데이터 · CSV는 각 패널에서 내려받기 · 기관·업체용</p>
    </div>
  );
}
