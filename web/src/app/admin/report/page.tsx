...
const CHANGELOG: [string, string][] = [
  ...
  ["2026-06", "지면 디지털화 1990~2001 완료(Google Vision OCR + Gemini 기사 재구조화)·띄어쓰기 이식·관리자 검수·독자 원본지면 뷰어"],
  ["2026-06", "뉴스 자동수집(RSS+기사목록 병합·회원로그인 전문수집·자정 cron) + AI 질의 RAG(아카이브 근거·날씨/대기질 실시간·출처 표기)"],
  ["2026-06", "주간 리포트 MVP — Workers AI 5섹션 초안(금 16시 cron) → 편집부 검토(HITL) 발행 → /reports 렌더"],
