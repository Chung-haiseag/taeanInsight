...
import { fetchReportMetrics, fetchLatestReport, fetchWeeklyNews, fetchOnThisDay, fetchCctv, fetchSeafog, fetchTvNews, getAgriPrices, getSeafood, getAuction, getSunset, getFestivals, getWeatherAlert } from "@/lib/api/reports";
import {
  SummaryInfographic, WeatherAirCard, MarineCard,
  DemandGauge, FestivalList, OilCard, RealEstatePanel, AgriCard, SeafoodCard, AuctionCard, SunsetCard, IndustryStructure, FestivalCalendar, WeatherAlertBanner,
...
export default async function LivePage() {
  ...
  const [metrics, onThisDay, cctv, seafog, news, tvNews, agri, seafood, auction, sunset, festivals, weatherAlert] = await Promise.all([
    fetchReportMetrics(),
    fetchOnThisDay(8),
    fetchCctv(),
    fetchSeafog(),
