...
- 2026-07-30 · 대기 UX: '답변 작성 중' 상태 바 + 태안신문 최신 소식 홍보: 완성본 대기(~24~53초)를 채움. SearchProgress에 진행률 %(경과시간 기반 추정: estimatePct 95*(1-e^(-t/15s)), 95%서 수렴해 가짜100% 방지)+결정형 바, 45%↑에서 헤더 '답변 작성 중…'+이유 안내. NewsPromo가 getNews 최신 4건(카테고리·제목·날짜, 새 탭)을 페이지 진입 시 preload해 로딩 중 노출 · web search-progress·news-promo·query-client, globals.css
