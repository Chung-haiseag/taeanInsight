...
- 2026-07-30 · 대기 UX: '답변 작성 중' 상태 바 + 태안신문 최신 소식 홍보: 완성본 대기(~24~53초)를 채움. SearchProgress 마지막 단계에서 헤더 '답변 작성 중…'+인디터미닛 상태 바(progress-indeterminate 키프레임)+이유 안내. NewsPromo가 getNews 최신 4건(카테고리·제목·날짜, 새 탭)을 페이지 진입 시 preload해 로딩 중 노출 · web search-progress·news-promo·query-client, globals.css
